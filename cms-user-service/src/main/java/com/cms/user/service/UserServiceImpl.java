...
import com.cms.user.constants.DatabaseConstant;
import com.cms.user.external.ChatBotService;
...
public class UserServiceImpl implements UserService {
	...
	public User registerUser(User user) {
		...
		if (createdUser.getRole().equals(DatabaseConstant.UserRole.CUSTOMER.value())) {
			chatBotService.init(String.valueOf(createdUser.getId()));
		}
